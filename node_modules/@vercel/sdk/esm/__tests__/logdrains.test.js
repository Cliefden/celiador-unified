...
it.skip("Logdrains Delete Configurable Log Drain", async () => {
    assert.fail("incomplete test found please make sure to address the following errors: [`workflow step deleteConfigurableLogDrain.test referencing operation deleteConfigurableLogDrain not found in document`]");
});
