...
export const tool$connectUpdateSharedConnectLinks = {
...
Allows updating project connections to shared Secure Compute networks.`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await connectUpdateSharedConnectLinks(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
