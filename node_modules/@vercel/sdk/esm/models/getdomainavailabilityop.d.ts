 ...
 */
export declare namespace GetDomainAvailabilityRequest$ {
    /** @deprecated use `GetDomainAvailabilityRequest$inboundSchema` instead. */
    const inboundSchema: z.ZodType<GetDomainAvailabilityRequest, z.ZodTypeDef, unknown>;
    /** @deprecated use `GetDomainAvailabilityRequest$outboundSchema` instead. */
    const outboundSchema: z.ZodType<GetDomainAvailabilityRequest$Outbound, z.ZodTypeDef, GetDomainAvailabilityRequest>;
    /** @deprecated use `GetDomainAvailabilityRequest$Outbound` instead. */
    type Outbound = GetDomainAvailabilityRequest$Outbound;
}
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace GetDomainAvailabilityResponseBody$ {
    /** @deprecated use `GetDomainAvailabilityResponseBody$inboundSchema` instead. */
    const inboundSchema: z.ZodType<GetDomainAvailabilityResponseBody, z.ZodTypeDef, unknown>;
    /** @deprecated use `GetDomainAvailabilityResponseBody$outboundSchema` instead. */
    const outboundSchema: z.ZodType<GetDomainAvailabilityResponseBody$Outbound, z.ZodTypeDef, GetDomainAvailabilityResponseBody>;
    /** @deprecated use `GetDomainAvailabilityResponseBody$Outbound` instead. */
    type Outbound = GetDomainAvailabilityResponseBody$Outbound;
}
