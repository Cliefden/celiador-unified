...
export declare const UserEventPayload148Action: {
    readonly Enable: "enable";
    readonly Disable: "disable";
};
export type UserEventPayload148Action = ClosedEnum<typeof UserEventPayload148Action>;
/**
 * The payload of the event, if requested.
 */
...
export declare const UserEventPayload86Action: {
    readonly Enabled: "enabled";
    readonly Disabled: "disabled";
    readonly Regenerated: "regenerated";
};
export type UserEventPayload86Action = ClosedEnum<typeof UserEventPayload86Action>;
/**
 * The payload of the event, if requested.
 */
...
export declare const UserEventPayload77Role: {
...
export declare const UserEventPayload65Action: {
    readonly HardBlocked: "hard-blocked";
    readonly SoftBlocked: "soft-blocked";
    readonly Unblocked: "unblocked";
};
export type UserEventPayload65Action = ClosedEnum<typeof UserEventPayload65Action>;
/**
 * Since June 2023
 */
...
export declare const UserEventPayload65Name: {
...
export declare const UserEventPayload65Role: {
    readonly Owner: "OWNER";
    readonly Member: "MEMBER";
    readonly Developer: "DEVELOPER";
    readonly Security: "SECURITY";
...
export declare const UserEventPayload65Type: {
    readonly User: "user";
};
...
export declare const UserEventPayload65BlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
};
export type UserEventPayload65BlockReason = ClosedEnum<typeof UserEventPayload65BlockReason>;
...
export declare const UserEventPayload65NewOwnerBlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
};
export type UserEventPayload65NewOwnerBlockReason = ClosedEnum<typeof UserEventPayload65NewOwnerBlockReason>;
...
export declare const UserEventPayload65NewOwnerFeatureBlocksBlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
};
export type UserEventPayload65NewOwnerFeatureBlocksBlockReason = ClosedEnum<typeof UserEventPayload65NewOwnerFeatureBlocksBlockReason>;
...
export declare const UserEventPayload65NewOwnerFeatureBlocksBlobBlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
};
export type UserEventPayload65NewOwnerFeatureBlocksBlobBlockReason = ClosedEnum<typeof UserEventPayload65NewOwnerFeatureBlocksBlobBlockReason>;
...
export declare const UserEventPayload65NewOwnerFeatureBlocksPostgresBlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
};
export type UserEventPayload65NewOwnerFeatureBlocksPostgresBlockReason = ClosedEnum<typeof UserEventPayload65NewOwnerFeatureBlocksPostgresBlockReason>;
...
export declare const UserEventPayload65NewOwnerFeatureBlocksRedisBlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
};
export type UserEventPayload65NewOwnerFeatureBlocksRedisBlockReason = ClosedEnum<typeof UserEventPayload65NewOwnerFeatureBlocksRedisBlockReason>;
...
export type Payload = SixtySeven | Seventy | SeventyOne | FortyOne | FortyTwo | FiftyFour | FiftyNine | SixtyFive | SixtyEight | OneHundredAndThirtyFive | OneHundredAndSixtyFive | Payload2 | FortySix | SixtyNine | OneHundredAndFour | OneHundredAndFortySix | Twelve | Sixteen | Thirty | ThirtyOne | ThirtyTwo | ThirtyThree | Forty | FortyNine | Fifty | FiftyOne | Sixty | SixtyOne | SixtyTwo | SixtyFour | SeventyFive | SeventyNine | EightyTwo | EightyThree | NinetyFive | OneHundredAndThirteen | OneHundredAndThirtySeven | OneHundredAndThirtyEight | OneHundredAndFortyFive | OneHundredAndFortySeven | OneHundredAndFortyNine | OneHundredAndFiftyTwo | OneHundredAndSixtyTwo | OneHundredAndSixtyThree | OneHundredAndSixtyFour | Four | Five | Six | Seventeen | Eighteen | TwentyThree | TwentyEight | ThirtyFive | ThirtySix | ThirtySeven | FortyFour | FortyFive | FortyEight | FiftyFive | SixtyThree | SixtySix | SeventyEight | EightySix | EightySeven | EightyEight | NinetyOne | NinetyTwo | NinetyThree | NinetyFour | NinetySix | NinetySeven | OneHundred | OneHundredAndOne | OneHundredAndTwo | OneHundredAndNine | OneHundredAndEighteen | OneHundredAndNineteen | OneHundredAndTwentyFour | OneHundredAndTwentyFive | OneHundredAndTwentySeven | OneHundredAndThirtySix | OneHundredAndThirtyNine | OneHundredAndForty | OneHundredAndFortyOne | OneHundredAndFortyThree | OneHundredAndFortyFour | OneHundredAndFifty | OneHundredAndFiftyOne | OneHundredAndFiftyThree | OneHundredAndFiftyFive | OneHundredAndFiftySix | OneHundredAndFiftySeven | OneHundredAndFiftyNine | Three | Fifteen | Twenty | TwentyTwo | TwentyFour | TwentySeven | TwentyNine | ThirtyFour | ThirtyEight | ThirtyNine | FortyThree | FortySeven | FiftyTwo | FiftyThree | SeventyTwo | SeventyThree | SeventyFour | SeventySix | SeventySeven | Eighty | EightyOne | EightyFour | EightyFive | EightyNine | Ninety | NinetyEight | NinetyNine | OneHundredAndThree | OneHundredAndFive | OneHundredAndSix | OneHundredAndSeven | OneHundredAndTen | OneHundredAndEleven | OneHundredAndTwelve | OneHundredAndSixteen | OneHundredAndSeventeen | OneHundredAndTwenty | OneHundredAndTwentySix | OneHundredAndTwentyEight | OneHundredAndThirtyTwo | OneHundredAndThirtyThree | OneHundredAndThirtyFour | OneHundredAndFortyTwo | OneHundredAndFortyEight | OneHundredAndFiftyFour | OneHundredAndFiftyEight | OneHundredAndSixty | OneHundredAndSixtyOne | Payload1 | Seven | Eight | Nine | Ten | Eleven | Thirteen | Fourteen | Nineteen | TwentyOne | TwentyFive | TwentySix | FiftySix | FiftySeven | FiftyEight | OneHundredAndEight | OneHundredAndFourteen | OneHundredAndFifteen | OneHundredAndTwentyOne | OneHundredAndTwentyTwo | OneHundredAndTwentyThree | OneHundredAndTwentyNine | OneHundredAndThirty | OneHundredAndThirtyOne;
/**
...
export type UserEvent = {
    ...
    payload?: SixtySeven | Seventy | SeventyOne | FortyOne | FortyTwo | FiftyFour | FiftyNine | SixtyFive | SixtyEight | OneHundredAndThirtyFive | OneHundredAndSixtyFive | Payload2 | FortySix | SixtyNine | OneHundredAndFour | OneHundredAndFortySix | Twelve | Sixteen | Thirty | ThirtyOne | ThirtyTwo | ThirtyThree | Forty | FortyNine | Fifty | FiftyOne | Sixty | SixtyOne | SixtyTwo | SixtyFour | SeventyFive | SeventyNine | EightyTwo | EightyThree | NinetyFive | OneHundredAndThirteen | OneHundredAndThirtySeven | OneHundredAndThirtyEight | OneHundredAndFortyFive | OneHundredAndFortySeven | OneHundredAndFortyNine | OneHundredAndFiftyTwo | OneHundredAndSixtyTwo | OneHundredAndSixtyThree | OneHundredAndSixtyFour | Four | Five | Six | Seventeen | Eighteen | TwentyThree | TwentyEight | ThirtyFive | ThirtySix | ThirtySeven | FortyFour | FortyFive | FortyEight | FiftyFive | SixtyThree | SixtySix | SeventyEight | EightySix | EightySeven | EightyEight | NinetyOne | NinetyTwo | NinetyThree | NinetyFour | NinetySix | NinetySeven | OneHundred | OneHundredAndOne | OneHundredAndTwo | OneHundredAndNine | OneHundredAndEighteen | OneHundredAndNineteen | OneHundredAndTwentyFour | OneHundredAndTwentyFive | OneHundredAndTwentySeven | OneHundredAndThirtySix | OneHundredAndThirtyNine | OneHundredAndForty | OneHundredAndFortyOne | OneHundredAndFortyThree | OneHundredAndFortyFour | OneHundredAndFifty | OneHundredAndFiftyOne | OneHundredAndFiftyThree | OneHundredAndFiftyFive | OneHundredAndFiftySix | OneHundredAndFiftySeven | OneHundredAndFiftyNine | Three | Fifteen | Twenty | TwentyTwo | TwentyFour | TwentySeven | TwentyNine | ThirtyFour | ThirtyEight | ThirtyNine | FortyThree | FortySeven | FiftyTwo | FiftyThree | SeventyTwo | SeventyThree | SeventyFour | SeventySix | SeventySeven | Eighty | EightyOne | EightyFour | EightyFive | EightyNine | Ninety | NinetyEight | NinetyNine | OneHundredAndThree | OneHundredAndFive | OneHundredAndSix | OneHundredAndSeven | OneHundredAndTen | OneHundredAndEleven | OneHundredAndTwelve | OneHundredAndSixteen | OneHundredAndSeventeen | OneHundredAndTwenty | OneHundredAndTwentySix | OneHundredAndTwentyEight | OneHundredAndThirtyTwo | OneHundredAndThirtyThree | OneHundredAndThirtyFour | OneHundredAndFortyTwo | OneHundredAndFortyEight | OneHundredAndFiftyFour | OneHundredAndFiftyEight | OneHundredAndSixty | OneHundredAndSixtyOne | Payload1 | Seven | Eight | Nine | Ten | Eleven | Thirteen | Fourteen | Nineteen | TwentyOne | TwentyFive | TwentySix | FiftySix | FiftySeven | FiftyEight | OneHundredAndEight | OneHundredAndFourteen | OneHundredAndFifteen | OneHundredAndTwentyOne | OneHundredAndTwentyTwo | OneHundredAndTwentyThree | OneHundredAndTwentyNine | OneHundredAndThirty | OneHundredAndThirtyOne | undefined;
};
/** @internal */
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace ClientAuthenticationUsed$ {
    /** @deprecated use `ClientAuthenticationUsed$inboundSchema` instead. */
    const inboundSchema: z.ZodType<ClientAuthenticationUsed, z.ZodTypeDef, unknown>;
    /** @deprecated use `ClientAuthenticationUsed$outboundSchema` instead. */
    const outboundSchema: z.ZodType<ClientAuthenticationUsed$Outbound, z.ZodTypeDef, ClientAuthenticationUsed>;
    /** @deprecated use `ClientAuthenticationUsed$Outbound` instead. */
    type Outbound = ClientAuthenticationUsed$Outbound;
}
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace OneHundredAndSixtyFive$ {
    /** @deprecated use `OneHundredAndSixtyFive$inboundSchema` instead. */
    const inboundSchema: z.ZodType<OneHundredAndSixtyFive, z.ZodTypeDef, unknown>;
    /** @deprecated use `OneHundredAndSixtyFive$outboundSchema` instead. */
    const outboundSchema: z.ZodType<OneHundredAndSixtyFive$Outbound, z.ZodTypeDef, OneHundredAndSixtyFive>;
    /** @deprecated use `OneHundredAndSixtyFive$Outbound` instead. */
    type Outbound = OneHundredAndSixtyFive$Outbound;
}
...
/** @internal */
export declare const UserEventPayload164Team$inboundSchema: z.ZodType<UserEventPayload164Team, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload164Team$outboundSchema: z.ZodType<UserEventPayload164Team$Outbound, z.ZodTypeDef, UserEventPayload164Team>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload164Team$ {
    /** @deprecated use `UserEventPayload164Team$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserEventPayload164Team, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserEventPayload164Team$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserEventPayload164Team$Outbound, z.ZodTypeDef, UserEventPayload164Team>;
    /** @deprecated use `UserEventPayload164Team$Outbound` instead. */
    type Outbound = UserEventPayload164Team$Outbound;
}
export declare function userEventPayload164TeamToJSON(userEventPayload164Team: UserEventPayload164Team): string;
export declare function userEventPayload164TeamFromJSON(jsonString: string): SafeParseResult<UserEventPayload164Team, SDKValidationError>;
/** @internal */
export declare const UserEventPayload164Configuration$inboundSchema: z.ZodType<UserEventPayload164Configuration, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload164Configuration$outboundSchema: z.ZodType<UserEventPayload164Configuration$Outbound, z.ZodTypeDef, UserEventPayload164Configuration>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload164Configuration$ {
    /** @deprecated use `UserEventPayload164Configuration$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserEventPayload164Configuration, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserEventPayload164Configuration$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserEventPayload164Configuration$Outbound, z.ZodTypeDef, UserEventPayload164Configuration>;
    /** @deprecated use `UserEventPayload164Configuration$Outbound` instead. */
    type Outbound = UserEventPayload164Configuration$Outbound;
}
export declare function userEventPayload164ConfigurationToJSON(userEventPayload164Configuration: UserEventPayload164Configuration): string;
export declare function userEventPayload164ConfigurationFromJSON(jsonString: string): SafeParseResult<UserEventPayload164Configuration, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload152Project$inboundSchema: z.ZodType<UserEventPayload152Project, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload152Project$outboundSchema: z.ZodType<UserEventPayload152Project$Outbound, z.ZodTypeDef, UserEventPayload152Project>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload152Project$ {
    /** @deprecated use `UserEventPayload152Project$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserEventPayload152Project, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserEventPayload152Project$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserEventPayload152Project$Outbound, z.ZodTypeDef, UserEventPayload152Project>;
    /** @deprecated use `UserEventPayload152Project$Outbound` instead. */
    type Outbound = UserEventPayload152Project$Outbound;
}
export declare function userEventPayload152ProjectToJSON(userEventPayload152Project: UserEventPayload152Project): string;
export declare function userEventPayload152ProjectFromJSON(jsonString: string): SafeParseResult<UserEventPayload152Project, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload152PrevProject$inboundSchema: z.ZodType<UserEventPayload152PrevProject, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload152PrevProject$outboundSchema: z.ZodType<UserEventPayload152PrevProject$Outbound, z.ZodTypeDef, UserEventPayload152PrevProject>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload152PrevProject$ {
    /** @deprecated use `UserEventPayload152PrevProject$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserEventPayload152PrevProject, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserEventPayload152PrevProject$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserEventPayload152PrevProject$Outbound, z.ZodTypeDef, UserEventPayload152PrevProject>;
    /** @deprecated use `UserEventPayload152PrevProject$Outbound` instead. */
    type Outbound = UserEventPayload152PrevProject$Outbound;
}
export declare function userEventPayload152PrevProjectToJSON(userEventPayload152PrevProject: UserEventPayload152PrevProject): string;
export declare function userEventPayload152PrevProjectFromJSON(jsonString: string): SafeParseResult<UserEventPayload152PrevProject, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload148Action$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload148Action>;
/** @internal */
export declare const UserEventPayload148Action$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload148Action>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload148Action$ {
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload142Role$ {
...
/** @internal */
export declare const UserEventPayload119User$inboundSchema: z.ZodType<UserEventPayload119User, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload119User$outboundSchema: z.ZodType<UserEventPayload119User$Outbound, z.ZodTypeDef, UserEventPayload119User>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload119User$ {
    /** @deprecated use `UserEventPayload119User$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserEventPayload119User, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserEventPayload119User$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserEventPayload119User$Outbound, z.ZodTypeDef, UserEventPayload119User>;
    /** @deprecated use `UserEventPayload119User$Outbound` instead. */
    type Outbound = UserEventPayload119User$Outbound;
}
export declare function userEventPayload119UserToJSON(userEventPayload119User: UserEventPayload119User): string;
export declare function userEventPayload119UserFromJSON(jsonString: string): SafeParseResult<UserEventPayload119User, SDKValidationError>;
/** @internal */
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload107Type$ {
...
/** @internal */
export declare const UserEventPayload100Team$inboundSchema: z.ZodType<UserEventPayload100Team, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload100Team$outboundSchema: z.ZodType<UserEventPayload100Team$Outbound, z.ZodTypeDef, UserEventPayload100Team>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload100Team$ {
    /** @deprecated use `UserEventPayload100Team$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserEventPayload100Team, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserEventPayload100Team$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserEventPayload100Team$Outbound, z.ZodTypeDef, UserEventPayload100Team>;
    /** @deprecated use `UserEventPayload100Team$Outbound` instead. */
    type Outbound = UserEventPayload100Team$Outbound;
}
export declare function userEventPayload100TeamToJSON(userEventPayload100Team: UserEventPayload100Team): string;
export declare function userEventPayload100TeamFromJSON(jsonString: string): SafeParseResult<UserEventPayload100Team, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload92Project$inboundSchema: z.ZodType<UserEventPayload92Project, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload92Project$outboundSchema: z.ZodType<UserEventPayload92Project$Outbound, z.ZodTypeDef, UserEventPayload92Project>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload92Project$ {
    /** @deprecated use `UserEventPayload92Project$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserEventPayload92Project, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserEventPayload92Project$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserEventPayload92Project$Outbound, z.ZodTypeDef, UserEventPayload92Project>;
    /** @deprecated use `UserEventPayload92Project$Outbound` instead. */
    type Outbound = UserEventPayload92Project$Outbound;
}
export declare function userEventPayload92ProjectToJSON(userEventPayload92Project: UserEventPayload92Project): string;
export declare function userEventPayload92ProjectFromJSON(jsonString: string): SafeParseResult<UserEventPayload92Project, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload92PreviousProject$inboundSchema: z.ZodType<UserEventPayload92PreviousProject, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload92PreviousProject$outboundSchema: z.ZodType<UserEventPayload92PreviousProject$Outbound, z.ZodTypeDef, UserEventPayload92PreviousProject>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload92PreviousProject$ {
    /** @deprecated use `UserEventPayload92PreviousProject$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserEventPayload92PreviousProject, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserEventPayload92PreviousProject$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserEventPayload92PreviousProject$Outbound, z.ZodTypeDef, UserEventPayload92PreviousProject>;
    /** @deprecated use `UserEventPayload92PreviousProject$Outbound` instead. */
    type Outbound = UserEventPayload92PreviousProject$Outbound;
}
export declare function userEventPayload92PreviousProjectToJSON(userEventPayload92PreviousProject: UserEventPayload92PreviousProject): string;
export declare function userEventPayload92PreviousProjectFromJSON(jsonString: string): SafeParseResult<UserEventPayload92PreviousProject, SDKValidationError>;
/** @internal */
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace PayloadReasonCode$ {
...
/** @internal */
export declare const UserEventPayload88Team$outboundSchema: z.ZodType<UserEventPayload88Team$Outbound, z.ZodTypeDef, UserEventPayload88Team>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload88Team$ {
    /** @deprecated use `UserEventPayload88Team$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserEventPayload88Team, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserEventPayload88Team$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserEventPayload88Team$Outbound, z.ZodTypeDef, UserEventPayload88Team>;
    /** @deprecated use `UserEventPayload88Team$Outbound` instead. */
    type Outbound = UserEventPayload88Team$Outbound;
}
export declare function userEventPayload88TeamToJSON(userEventPayload88Team: UserEventPayload88Team): string;
...
/** @internal */
export declare const UserEventPayload88Project$inboundSchema: z.ZodType<UserEventPayload88Project, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload88Project$outboundSchema: z.ZodType<UserEventPayload88Project$Outbound, z.ZodTypeDef, UserEventPayload88Project>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload88Project$ {
    /** @deprecated use `UserEventPayload88Project$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserEventPayload88Project, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserEventPayload88Project$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserEventPayload88Project$Outbound, z.ZodTypeDef, UserEventPayload88Project>;
    /** @deprecated use `UserEventPayload88Project$Outbound` instead. */
    type Outbound = UserEventPayload88Project$Outbound;
}
export declare function userEventPayload88ProjectToJSON(userEventPayload88Project: UserEventPayload88Project): string;
export declare function userEventPayload88ProjectFromJSON(jsonString: string): SafeParseResult<UserEventPayload88Project, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload86Action$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload86Action>;
/** @internal */
export declare const UserEventPayload86Action$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload86Action>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload86Action$ {
...
/** @internal */
export declare const UserEventPayload77Role$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload77Role>;
/** @internal */
export declare const UserEventPayload77Role$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload77Role>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload77Role$ {
...
/** @internal */
export declare const UserEventPayload65Action$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload65Action>;
/** @internal */
export declare const UserEventPayload65Action$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload65Action>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload65Action$ {
...
/** @internal */
export declare const UserEventPayload65Name$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload65Name>;
/** @internal */
export declare const UserEventPayload65Name$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload65Name>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload65Name$ {
...
/** @internal */
export declare const UserEventPayload65Role$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload65Role>;
/** @internal */
export declare const UserEventPayload65Role$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload65Role>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload65Role$ {
...
/** @internal */
export declare const UserEventPayload65Type$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload65Type>;
/** @internal */
export declare const UserEventPayload65Type$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload65Type>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload65Type$ {
...
/** @internal */
export declare const UserEventPayload65BlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload65BlockReason>;
/** @internal */
export declare const UserEventPayload65BlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload65BlockReason>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload65BlockReason$ {
...
/** @internal */
export declare const UserEventPayload65NewOwnerBlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload65NewOwnerBlockReason>;
/** @internal */
export declare const UserEventPayload65NewOwnerBlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload65NewOwnerBlockReason>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload65NewOwnerBlockReason$ {
...
/** @internal */
export declare const UserEventPayload65NewOwnerFeatureBlocksBlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload65NewOwnerFeatureBlocksBlockReason>;
/** @internal */
export declare const UserEventPayload65NewOwnerFeatureBlocksBlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload65NewOwnerFeatureBlocksBlockReason>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload65NewOwnerFeatureBlocksBlockReason$ {
...
/** @internal */
export declare const UserEventPayload65NewOwnerFeatureBlocksBlobBlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload65NewOwnerFeatureBlocksBlobBlockReason>;
/** @internal */
export declare const UserEventPayload65NewOwnerFeatureBlocksBlobBlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload65NewOwnerFeatureBlocksBlobBlockReason>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload65NewOwnerFeatureBlocksBlobBlockReason$ {
...
/** @internal */
export declare const UserEventPayload65NewOwnerFeatureBlocksPostgresBlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload65NewOwnerFeatureBlocksPostgresBlockReason>;
/** @internal */
export declare const UserEventPayload65NewOwnerFeatureBlocksPostgresBlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload65NewOwnerFeatureBlocksPostgresBlockReason>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload65NewOwnerFeatureBlocksPostgresBlockReason$ {
...
/** @internal */
export declare const UserEventPayload65NewOwnerFeatureBlocksRedisBlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload65NewOwnerFeatureBlocksRedisBlockReason>;
/** @internal */
export declare const UserEventPayload65NewOwnerFeatureBlocksRedisBlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload65NewOwnerFeatureBlocksRedisBlockReason>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload65NewOwnerFeatureBlocksRedisBlockReason$ {
...
/** @internal */
export declare const UserEventPayload37Project$inboundSchema: z.ZodType<UserEventPayload37Project, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload37Project$Outbound = {
    name: string;
};
/** @internal */
export declare const UserEventPayload37Project$outboundSchema: z.ZodType<UserEventPayload37Project$Outbound, z.ZodTypeDef, UserEventPayload37Project>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload37Project$ {
    /** @deprecated use `UserEventPayload37Project$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserEventPayload37Project, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserEventPayload37Project$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserEventPayload37Project$Outbound, z.ZodTypeDef, UserEventPayload37Project>;
    /** @deprecated use `UserEventPayload37Project$Outbound` instead. */
    type Outbound = UserEventPayload37Project$Outbound;
}
export declare function userEventPayload37ProjectToJSON(userEventPayload37Project: UserEventPayload37Project): string;
export declare function userEventPayload37ProjectFromJSON(jsonString: string): SafeParseResult<UserEventPayload37Project, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload33Team$inboundSchema: z.ZodType<UserEventPayload33Team, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload33Team$outboundSchema: z.ZodType<UserEventPayload33Team$Outbound, z.ZodTypeDef, UserEventPayload33Team>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload33Team$ {
    /** @deprecated use `UserEventPayload33Team$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserEventPayload33Team, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserEventPayload33Team$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserEventPayload33Team$Outbound, z.ZodTypeDef, UserEventPayload33Team>;
    /** @deprecated use `UserEventPayload33Team$Outbound` instead. */
    type Outbound = UserEventPayload33Team$Outbound;
}
export declare function userEventPayload33TeamToJSON(userEventPayload33Team: UserEventPayload33Team): string;
export declare function userEventPayload33TeamFromJSON(jsonString: string): SafeParseResult<UserEventPayload33Team, SDKValidationError>;
/** @internal */
export declare const UserEventPayload33Configuration$inboundSchema: z.ZodType<UserEventPayload33Configuration, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload33Configuration$outboundSchema: z.ZodType<UserEventPayload33Configuration$Outbound, z.ZodTypeDef, UserEventPayload33Configuration>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload33Configuration$ {
    /** @deprecated use `UserEventPayload33Configuration$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserEventPayload33Configuration, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserEventPayload33Configuration$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserEventPayload33Configuration$Outbound, z.ZodTypeDef, UserEventPayload33Configuration>;
    /** @deprecated use `UserEventPayload33Configuration$Outbound` instead. */
    type Outbound = UserEventPayload33Configuration$Outbound;
}
export declare function userEventPayload33ConfigurationToJSON(userEventPayload33Configuration: UserEventPayload33Configuration): string;
export declare function userEventPayload33ConfigurationFromJSON(jsonString: string): SafeParseResult<UserEventPayload33Configuration, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload32Project$inboundSchema: z.ZodType<UserEventPayload32Project, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload32Project$outboundSchema: z.ZodType<UserEventPayload32Project$Outbound, z.ZodTypeDef, UserEventPayload32Project>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload32Project$ {
    /** @deprecated use `UserEventPayload32Project$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserEventPayload32Project, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserEventPayload32Project$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserEventPayload32Project$Outbound, z.ZodTypeDef, UserEventPayload32Project>;
    /** @deprecated use `UserEventPayload32Project$Outbound` instead. */
    type Outbound = UserEventPayload32Project$Outbound;
}
export declare function userEventPayload32ProjectToJSON(userEventPayload32Project: UserEventPayload32Project): string;
export declare function userEventPayload32ProjectFromJSON(jsonString: string): SafeParseResult<UserEventPayload32Project, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload30Team$inboundSchema: z.ZodType<UserEventPayload30Team, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload30Team$outboundSchema: z.ZodType<UserEventPayload30Team$Outbound, z.ZodTypeDef, UserEventPayload30Team>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload30Team$ {
    /** @deprecated use `UserEventPayload30Team$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserEventPayload30Team, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserEventPayload30Team$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserEventPayload30Team$Outbound, z.ZodTypeDef, UserEventPayload30Team>;
    /** @deprecated use `UserEventPayload30Team$Outbound` instead. */
    type Outbound = UserEventPayload30Team$Outbound;
}
export declare function userEventPayload30TeamToJSON(userEventPayload30Team: UserEventPayload30Team): string;
export declare function userEventPayload30TeamFromJSON(jsonString: string): SafeParseResult<UserEventPayload30Team, SDKValidationError>;
/** @internal */
...
/** @internal */
export type Payload$Outbound = SixtySeven$Outbound | Seventy$Outbound | SeventyOne$Outbound | FortyOne$Outbound | FortyTwo$Outbound | FiftyFour$Outbound | FiftyNine$Outbound | SixtyFive$Outbound | SixtyEight$Outbound | OneHundredAndThirtyFive$Outbound | OneHundredAndSixtyFive$Outbound | Payload2$Outbound | FortySix$Outbound | SixtyNine$Outbound | OneHundredAndFour$Outbound | OneHundredAndFortySix$Outbound | Twelve$Outbound | Sixteen$Outbound | Thirty$Outbound | ThirtyOne$Outbound | ThirtyTwo$Outbound | ThirtyThree$Outbound | Forty$Outbound | FortyNine$Outbound | Fifty$Outbound | FiftyOne$Outbound | Sixty$Outbound | SixtyOne$Outbound | SixtyTwo$Outbound | SixtyFour$Outbound | SeventyFive$Outbound | SeventyNine$Outbound | EightyTwo$Outbound | EightyThree$Outbound | NinetyFive$Outbound | OneHundredAndThirteen$Outbound | OneHundredAndThirtySeven$Outbound | OneHundredAndThirtyEight$Outbound | OneHundredAndFortyFive$Outbound | OneHundredAndFortySeven$Outbound | OneHundredAndFortyNine$Outbound | OneHundredAndFiftyTwo$Outbound | OneHundredAndSixtyTwo$Outbound | OneHundredAndSixtyThree$Outbound | OneHundredAndSixtyFour$Outbound | Four$Outbound | Five$Outbound | Six$Outbound | Seventeen$Outbound | Eighteen$Outbound | TwentyThree$Outbound | TwentyEight$Outbound | ThirtyFive$Outbound | ThirtySix$Outbound | ThirtySeven$Outbound | FortyFour$Outbound | FortyFive$Outbound | FortyEight$Outbound | FiftyFive$Outbound | SixtyThree$Outbound | SixtySix$Outbound | SeventyEight$Outbound | EightySix$Outbound | EightySeven$Outbound | EightyEight$Outbound | NinetyOne$Outbound | NinetyTwo$Outbound | NinetyThree$Outbound | NinetyFour$Outbound | NinetySix$Outbound | NinetySeven$Outbound | OneHundred$Outbound | OneHundredAndOne$Outbound | OneHundredAndTwo$Outbound | OneHundredAndNine$Outbound | OneHundredAndEighteen$Outbound | OneHundredAndNineteen$Outbound | OneHundredAndTwentyFour$Outbound | OneHundredAndTwentyFive$Outbound | OneHundredAndTwentySeven$Outbound | OneHundredAndThirtySix$Outbound | OneHundredAndThirtyNine$Outbound | OneHundredAndForty$Outbound | OneHundredAndFortyOne$Outbound | OneHundredAndFortyThree$Outbound | OneHundredAndFortyFour$Outbound | OneHundredAndFifty$Outbound | OneHundredAndFiftyOne$Outbound | OneHundredAndFiftyThree$Outbound | OneHundredAndFiftyFive$Outbound | OneHundredAndFiftySix$Outbound | OneHundredAndFiftySeven$Outbound | OneHundredAndFiftyNine$Outbound | Three$Outbound | Fifteen$Outbound | Twenty$Outbound | TwentyTwo$Outbound | TwentyFour$Outbound | TwentySeven$Outbound | TwentyNine$Outbound | ThirtyFour$Outbound | ThirtyEight$Outbound | ThirtyNine$Outbound | FortyThree$Outbound | FortySeven$Outbound | FiftyTwo$Outbound | FiftyThree$Outbound | SeventyTwo$Outbound | SeventyThree$Outbound | SeventyFour$Outbound | SeventySix$Outbound | SeventySeven$Outbound | Eighty$Outbound | EightyOne$Outbound | EightyFour$Outbound | EightyFive$Outbound | EightyNine$Outbound | Ninety$Outbound | NinetyEight$Outbound | NinetyNine$Outbound | OneHundredAndThree$Outbound | OneHundredAndFive$Outbound | OneHundredAndSix$Outbound | OneHundredAndSeven$Outbound | OneHundredAndTen$Outbound | OneHundredAndEleven$Outbound | OneHundredAndTwelve$Outbound | OneHundredAndSixteen$Outbound | OneHundredAndSeventeen$Outbound | OneHundredAndTwenty$Outbound | OneHundredAndTwentySix$Outbound | OneHundredAndTwentyEight$Outbound | OneHundredAndThirtyTwo$Outbound | OneHundredAndThirtyThree$Outbound | OneHundredAndThirtyFour$Outbound | OneHundredAndFortyTwo$Outbound | OneHundredAndFortyEight$Outbound | OneHundredAndFiftyFour$Outbound | OneHundredAndFiftyEight$Outbound | OneHundredAndSixty$Outbound | OneHundredAndSixtyOne$Outbound | Payload1$Outbound | Seven$Outbound | Eight$Outbound | Nine$Outbound | Ten$Outbound | Eleven$Outbound | Thirteen$Outbound | Fourteen$Outbound | Nineteen$Outbound | TwentyOne$Outbound | TwentyFive$Outbound | TwentySix$Outbound | FiftySix$Outbound | FiftySeven$Outbound | FiftyEight$Outbound | OneHundredAndEight$Outbound | OneHundredAndFourteen$Outbound | OneHundredAndFifteen$Outbound | OneHundredAndTwentyOne$Outbound | OneHundredAndTwentyTwo$Outbound | OneHundredAndTwentyThree$Outbound | OneHundredAndTwentyNine$Outbound | OneHundredAndThirty$Outbound | OneHundredAndThirtyOne$Outbound;
/** @internal */
...
export type UserEvent$Outbound = {
    ...
    principalId: string;
    viaIds?: Array<string> | undefined;
    payload?: SixtySeven$Outbound | Seventy$Outbound | SeventyOne$Outbound | FortyOne$Outbound | FortyTwo$Outbound | FiftyFour$Outbound | FiftyNine$Outbound | SixtyFive$Outbound | SixtyEight$Outbound | OneHundredAndThirtyFive$Outbound | OneHundredAndSixtyFive$Outbound | Payload2$Outbound | FortySix$Outbound | SixtyNine$Outbound | OneHundredAndFour$Outbound | OneHundredAndFortySix$Outbound | Twelve$Outbound | Sixteen$Outbound | Thirty$Outbound | ThirtyOne$Outbound | ThirtyTwo$Outbound | ThirtyThree$Outbound | Forty$Outbound | FortyNine$Outbound | Fifty$Outbound | FiftyOne$Outbound | Sixty$Outbound | SixtyOne$Outbound | SixtyTwo$Outbound | SixtyFour$Outbound | SeventyFive$Outbound | SeventyNine$Outbound | EightyTwo$Outbound | EightyThree$Outbound | NinetyFive$Outbound | OneHundredAndThirteen$Outbound | OneHundredAndThirtySeven$Outbound | OneHundredAndThirtyEight$Outbound | OneHundredAndFortyFive$Outbound | OneHundredAndFortySeven$Outbound | OneHundredAndFortyNine$Outbound | OneHundredAndFiftyTwo$Outbound | OneHundredAndSixtyTwo$Outbound | OneHundredAndSixtyThree$Outbound | OneHundredAndSixtyFour$Outbound | Four$Outbound | Five$Outbound | Six$Outbound | Seventeen$Outbound | Eighteen$Outbound | TwentyThree$Outbound | TwentyEight$Outbound | ThirtyFive$Outbound | ThirtySix$Outbound | ThirtySeven$Outbound | FortyFour$Outbound | FortyFive$Outbound | FortyEight$Outbound | FiftyFive$Outbound | SixtyThree$Outbound | SixtySix$Outbound | SeventyEight$Outbound | EightySix$Outbound | EightySeven$Outbound | EightyEight$Outbound | NinetyOne$Outbound | NinetyTwo$Outbound | NinetyThree$Outbound | NinetyFour$Outbound | NinetySix$Outbound | NinetySeven$Outbound | OneHundred$Outbound | OneHundredAndOne$Outbound | OneHundredAndTwo$Outbound | OneHundredAndNine$Outbound | OneHundredAndEighteen$Outbound | OneHundredAndNineteen$Outbound | OneHundredAndTwentyFour$Outbound | OneHundredAndTwentyFive$Outbound | OneHundredAndTwentySeven$Outbound | OneHundredAndThirtySix$Outbound | OneHundredAndThirtyNine$Outbound | OneHundredAndForty$Outbound | OneHundredAndFortyOne$Outbound | OneHundredAndFortyThree$Outbound | OneHundredAndFortyFour$Outbound | OneHundredAndFifty$Outbound | OneHundredAndFiftyOne$Outbound | OneHundredAndFiftyThree$Outbound | OneHundredAndFiftyFive$Outbound | OneHundredAndFiftySix$Outbound | OneHundredAndFiftySeven$Outbound | OneHundredAndFiftyNine$Outbound | Three$Outbound | Fifteen$Outbound | Twenty$Outbound | TwentyTwo$Outbound | TwentyFour$Outbound | TwentySeven$Outbound | TwentyNine$Outbound | ThirtyFour$Outbound | ThirtyEight$Outbound | ThirtyNine$Outbound | FortyThree$Outbound | FortySeven$Outbound | FiftyTwo$Outbound | FiftyThree$Outbound | SeventyTwo$Outbound | SeventyThree$Outbound | SeventyFour$Outbound | SeventySix$Outbound | SeventySeven$Outbound | Eighty$Outbound | EightyOne$Outbound | EightyFour$Outbound | EightyFive$Outbound | EightyNine$Outbound | Ninety$Outbound | NinetyEight$Outbound | NinetyNine$Outbound | OneHundredAndThree$Outbound | OneHundredAndFive$Outbound | OneHundredAndSix$Outbound | OneHundredAndSeven$Outbound | OneHundredAndTen$Outbound | OneHundredAndEleven$Outbound | OneHundredAndTwelve$Outbound | OneHundredAndSixteen$Outbound | OneHundredAndSeventeen$Outbound | OneHundredAndTwenty$Outbound | OneHundredAndTwentySix$Outbound | OneHundredAndTwentyEight$Outbound | OneHundredAndThirtyTwo$Outbound | OneHundredAndThirtyThree$Outbound | OneHundredAndThirtyFour$Outbound | OneHundredAndFortyTwo$Outbound | OneHundredAndFortyEight$Outbound | OneHundredAndFiftyFour$Outbound | OneHundredAndFiftyEight$Outbound | OneHundredAndSixty$Outbound | OneHundredAndSixtyOne$Outbound | Payload1$Outbound | Seven$Outbound | Eight$Outbound | Nine$Outbound | Ten$Outbound | Eleven$Outbound | Thirteen$Outbound | Fourteen$Outbound | Nineteen$Outbound | TwentyOne$Outbound | TwentyFive$Outbound | TwentySix$Outbound | FiftySix$Outbound | FiftySeven$Outbound | FiftyEight$Outbound | OneHundredAndEight$Outbound | OneHundredAndFourteen$Outbound | OneHundredAndFifteen$Outbound | OneHundredAndTwentyOne$Outbound | OneHundredAndTwentyTwo$Outbound | OneHundredAndTwentyThree$Outbound | OneHundredAndTwentyNine$Outbound | OneHundredAndThirty$Outbound | OneHundredAndThirtyOne$Outbound | undefined;
};
/** @internal */
