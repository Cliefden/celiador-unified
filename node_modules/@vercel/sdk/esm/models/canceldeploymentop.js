 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var CancelDeploymentGitSource7$;
(function (CancelDeploymentGitSource7$) {
    /** @deprecated use `CancelDeploymentGitSource7$inboundSchema` instead. */
    CancelDeploymentGitSource7$.inboundSchema = CancelDeploymentGitSource7$inboundSchema;
    /** @deprecated use `CancelDeploymentGitSource7$outboundSchema` instead. */
    CancelDeploymentGitSource7$.outboundSchema = CancelDeploymentGitSource7$outboundSchema;
...
/** @internal */
export const CancelDeploymentHasValue$inboundSchema = z.union([z.string(), z.lazy(() => CancelDeploymentValue2$inboundSchema)]);
/** @internal */
export const CancelDeploymentHasValue$outboundSchema = z.union([z.string(), z.lazy(() => CancelDeploymentValue2$outboundSchema)]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
...
/** @internal */
export const CancelDeploymentRoutesKey$inboundSchema = z.union([z.string(), z.lazy(() => CancelDeploymentKey2$inboundSchema)]);
/** @internal */
export const CancelDeploymentRoutesKey$outboundSchema = z.union([z.string(), z.lazy(() => CancelDeploymentKey2$outboundSchema)]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var CancelDeploymentRoutesKey$;
(function (CancelDeploymentRoutesKey$) {
    /** @deprecated use `CancelDeploymentRoutesKey$inboundSchema` instead. */
    CancelDeploymentRoutesKey$.inboundSchema = CancelDeploymentRoutesKey$inboundSchema;
    /** @deprecated use `CancelDeploymentRoutesKey$outboundSchema` instead. */
    CancelDeploymentRoutesKey$.outboundSchema = CancelDeploymentRoutesKey$outboundSchema;
})(CancelDeploymentRoutesKey$ || (CancelDeploymentRoutesKey$ = {}));
export function cancelDeploymentRoutesKeyToJSON(cancelDeploymentRoutesKey) {
    return JSON.stringify(CancelDeploymentRoutesKey$outboundSchema.parse(cancelDeploymentRoutesKey));
}
export function cancelDeploymentRoutesKeyFromJSON(jsonString) {
    return safeParse(jsonString, (x) => CancelDeploymentRoutesKey$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CancelDeploymentRoutesKey' from JSON`);
}
/** @internal */
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var MicrofrontendsMfeConfigUploadState$;
(function (MicrofrontendsMfeConfigUploadState$) {
    /** @deprecated use `MicrofrontendsMfeConfigUploadState$inboundSchema` instead. */
    MicrofrontendsMfeConfigUploadState$.inboundSchema = MicrofrontendsMfeConfigUploadState$inboundSchema;
    /** @deprecated use `MicrofrontendsMfeConfigUploadState$outboundSchema` instead. */
    MicrofrontendsMfeConfigUploadState$.outboundSchema = MicrofrontendsMfeConfigUploadState$outboundSchema;
})(MicrofrontendsMfeConfigUploadState$ || (MicrofrontendsMfeConfigUploadState$ = {}));
/** @internal */
