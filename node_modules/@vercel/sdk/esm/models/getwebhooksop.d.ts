 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace ResponseBodyProjectsMetadata$ {
    /** @deprecated use `ResponseBodyProjectsMetadata$inboundSchema` instead. */
    const inboundSchema: z.ZodType<ResponseBodyProjectsMetadata, z.ZodTypeDef, unknown>;
    /** @deprecated use `ResponseBodyProjectsMetadata$outboundSchema` instead. */
    const outboundSchema: z.ZodType<ResponseBodyProjectsMetadata$Outbound, z.ZodTypeDef, ResponseBodyProjectsMetadata>;
    /** @deprecated use `ResponseBodyProjectsMetadata$Outbound` instead. */
    type Outbound = ResponseBodyProjectsMetadata$Outbound;
}
