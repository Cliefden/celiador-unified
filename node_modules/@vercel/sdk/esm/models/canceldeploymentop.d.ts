 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace CancelDeploymentGitSource7$ {
    /** @deprecated use `CancelDeploymentGitSource7$inboundSchema` instead. */
    const inboundSchema: z.ZodType<CancelDeploymentGitSource7, z.ZodTypeDef, unknown>;
    /** @deprecated use `CancelDeploymentGitSource7$outboundSchema` instead. */
    const outboundSchema: z.ZodType<CancelDeploymentGitSource7$Outbound, z.ZodTypeDef, CancelDeploymentGitSource7>;
    /** @deprecated use `CancelDeploymentGitSource7$Outbound` instead. */
    type Outbound = CancelDeploymentGitSource7$Outbound;
}
...
/** @internal */
export type CancelDeploymentRoutesKey$Outbound = string | CancelDeploymentKey2$Outbound;
/** @internal */
