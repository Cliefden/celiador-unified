 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var BuySingleDomainDomainsRegistrarResponseResponseBody$;
(function (BuySingleDomainDomainsRegistrarResponseResponseBody$) {
    /** @deprecated use `BuySingleDomainDomainsRegistrarResponseResponseBody$inboundSchema` instead. */
    BuySingleDomainDomainsRegistrarResponseResponseBody$.inboundSchema = BuySingleDomainDomainsRegistrarResponseResponseBody$inboundSchema;
...
})(BuySingleDomainDomainsRegistrarResponseResponseBody$ || (BuySingleDomainDomainsRegistrarResponseResponseBody$ = {}));
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var BuySingleDomainMethod$;
(function (BuySingleDomainMethod$) {
    /** @deprecated use `BuySingleDomainMethod$inboundSchema` instead. */
    BuySingleDomainMethod$.inboundSchema = BuySingleDomainMethod$inboundSchema;
    /** @deprecated use `BuySingleDomainMethod$outboundSchema` instead. */
    BuySingleDomainMethod$.outboundSchema = BuySingleDomainMethod$outboundSchema;
})(BuySingleDomainMethod$ || (BuySingleDomainMethod$ = {}));
/** @internal */
