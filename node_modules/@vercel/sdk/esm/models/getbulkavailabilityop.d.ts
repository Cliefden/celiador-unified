 ...
 */
export declare namespace GetBulkAvailabilityRequestBody$ {
    /** @deprecated use `GetBulkAvailabilityRequestBody$inboundSchema` instead. */
    const inboundSchema: z.ZodType<GetBulkAvailabilityRequestBody, z.ZodTypeDef, unknown>;
    /** @deprecated use `GetBulkAvailabilityRequestBody$outboundSchema` instead. */
    const outboundSchema: z.ZodType<GetBulkAvailabilityRequestBody$Outbound, z.ZodTypeDef, GetBulkAvailabilityRequestBody>;
    /** @deprecated use `GetBulkAvailabilityRequestBody$Outbound` instead. */
    type Outbound = GetBulkAvailabilityRequestBody$Outbound;
}
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace GetBulkAvailabilityRequest$ {
    /** @deprecated use `GetBulkAvailabilityRequest$inboundSchema` instead. */
    const inboundSchema: z.ZodType<GetBulkAvailabilityRequest, z.ZodTypeDef, unknown>;
    /** @deprecated use `GetBulkAvailabilityRequest$outboundSchema` instead. */
    const outboundSchema: z.ZodType<GetBulkAvailabilityRequest$Outbound, z.ZodTypeDef, GetBulkAvailabilityRequest>;
    /** @deprecated use `GetBulkAvailabilityRequest$Outbound` instead. */
    type Outbound = GetBulkAvailabilityRequest$Outbound;
}
...
export declare namespace Results$ {
    ...
    const inboundSchema: z.ZodType<Results, z.ZodTypeDef, unknown>;
    /** @deprecated use `Results$outboundSchema` instead. */
    const outboundSchema: z.ZodType<Results$Outbound, z.ZodTypeDef, Results>;
    /** @deprecated use `Results$Outbound` instead. */
    type Outbound = Results$Outbound;
}
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace GetBulkAvailabilityResponseBody$ {
    /** @deprecated use `GetBulkAvailabilityResponseBody$inboundSchema` instead. */
    const inboundSchema: z.ZodType<GetBulkAvailabilityResponseBody, z.ZodTypeDef, unknown>;
    /** @deprecated use `GetBulkAvailabilityResponseBody$outboundSchema` instead. */
    const outboundSchema: z.ZodType<GetBulkAvailabilityResponseBody$Outbound, z.ZodTypeDef, GetBulkAvailabilityResponseBody>;
    /** @deprecated use `GetBulkAvailabilityResponseBody$Outbound` instead. */
    type Outbound = GetBulkAvailabilityResponseBody$Outbound;
}
