 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UpdateProjectStaticIps$ {
    /** @deprecated use `UpdateProjectStaticIps$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UpdateProjectStaticIps, z.ZodTypeDef, unknown>;
    /** @deprecated use `UpdateProjectStaticIps$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UpdateProjectStaticIps$Outbound, z.ZodTypeDef, UpdateProjectStaticIps>;
    /** @deprecated use `UpdateProjectStaticIps$Outbound` instead. */
    type Outbound = UpdateProjectStaticIps$Outbound;
}
