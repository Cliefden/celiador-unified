 ...
 */
export declare namespace GetDomainTransferInRequest$ {
    /** @deprecated use `GetDomainTransferInRequest$inboundSchema` instead. */
    const inboundSchema: z.ZodType<GetDomainTransferInRequest, z.ZodTypeDef, unknown>;
    /** @deprecated use `GetDomainTransferInRequest$outboundSchema` instead. */
    const outboundSchema: z.ZodType<GetDomainTransferInRequest$Outbound, z.ZodTypeDef, GetDomainTransferInRequest>;
    /** @deprecated use `GetDomainTransferInRequest$Outbound` instead. */
    type Outbound = GetDomainTransferInRequest$Outbound;
}
...
/** @internal */
export declare const GetDomainTransferInDomainsRegistrarResponseBody$outboundSchema: z.ZodType<GetDomainTransferInDomainsRegistrarResponseBody$Outbound, z.ZodTypeDef, GetDomainTransferInDomainsRegistrarResponseBody>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace GetDomainTransferInDomainsRegistrarResponseBody$ {
    /** @deprecated use `GetDomainTransferInDomainsRegistrarResponseBody$inboundSchema` instead. */
    const inboundSchema: z.ZodType<GetDomainTransferInDomainsRegistrarResponseBody, z.ZodTypeDef, unknown>;
    /** @deprecated use `GetDomainTransferInDomainsRegistrarResponseBody$outboundSchema` instead. */
    const outboundSchema: z.ZodType<GetDomainTransferInDomainsRegistrarResponseBody$Outbound, z.ZodTypeDef, GetDomainTransferInDomainsRegistrarResponseBody>;
    /** @deprecated use `GetDomainTransferInDomainsRegistrarResponseBody$Outbound` instead. */
    type Outbound = GetDomainTransferInDomainsRegistrarResponseBody$Outbound;
}
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace GetDomainTransferInStatus$ {
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace GetDomainTransferInResponseBody$ {
    /** @deprecated use `GetDomainTransferInResponseBody$inboundSchema` instead. */
    const inboundSchema: z.ZodType<GetDomainTransferInResponseBody, z.ZodTypeDef, unknown>;
    /** @deprecated use `GetDomainTransferInResponseBody$outboundSchema` instead. */
    const outboundSchema: z.ZodType<GetDomainTransferInResponseBody$Outbound, z.ZodTypeDef, GetDomainTransferInResponseBody>;
    /** @deprecated use `GetDomainTransferInResponseBody$Outbound` instead. */
    type Outbound = GetDomainTransferInResponseBody$Outbound;
}
