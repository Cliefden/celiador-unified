 ...
 */
export type BuySingleDomainDomainsRegistrarResponseBody = OrderTooExpensive | InvalidAdditionalContactInfo | AdditionalContactInfoRequired | ExpectedPriceMismatch | DomainNotAvailable | TldNotSupported | HttpApiDecodeError;
...
/** @internal */
export declare const BuySingleDomainDomainsRegistrarResponseResponseBody$outboundSchema: z.ZodType<BuySingleDomainDomainsRegistrarResponseResponseBody$Outbound, z.ZodTypeDef, BuySingleDomainDomainsRegistrarResponseResponseBody>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace BuySingleDomainDomainsRegistrarResponseResponseBody$ {
    /** @deprecated use `BuySingleDomainDomainsRegistrarResponseResponseBody$inboundSchema` instead. */
    const inboundSchema: z.ZodType<BuySingleDomainDomainsRegistrarResponseResponseBody, z.ZodTypeDef, unknown>;
    /** @deprecated use `BuySingleDomainDomainsRegistrarResponseResponseBody$outboundSchema` instead. */
    const outboundSchema: z.ZodType<BuySingleDomainDomainsRegistrarResponseResponseBody$Outbound, z.ZodTypeDef, BuySingleDomainDomainsRegistrarResponseResponseBody>;
    /** @deprecated use `BuySingleDomainDomainsRegistrarResponseResponseBody$Outbound` instead. */
    type Outbound = BuySingleDomainDomainsRegistrarResponseResponseBody$Outbound;
}
...
/** @internal */
export type BuySingleDomainDomainsRegistrarResponseBody$Outbound = OrderTooExpensive$Outbound | InvalidAdditionalContactInfo$Outbound | AdditionalContactInfoRequired$Outbound | ExpectedPriceMismatch$Outbound | DomainNotAvailable$Outbound | TldNotSupported$Outbound | HttpApiDecodeError$Outbound;
/** @internal */
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace BuySingleDomainMethod$ {
