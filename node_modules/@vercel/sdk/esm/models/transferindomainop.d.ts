 ...
 */
export type TransferInDomainDomainsRegistrarResponseBody = BadRequest | ExpectedPriceMismatch | DomainNotAvailable | TldNotSupported | HttpApiDecodeError;
...
/** @internal */
export declare const TransferInDomainDomainsRegistrarResponseResponseBody$outboundSchema: z.ZodType<TransferInDomainDomainsRegistrarResponseResponseBody$Outbound, z.ZodTypeDef, TransferInDomainDomainsRegistrarResponseResponseBody>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace TransferInDomainDomainsRegistrarResponseResponseBody$ {
    /** @deprecated use `TransferInDomainDomainsRegistrarResponseResponseBody$inboundSchema` instead. */
    const inboundSchema: z.ZodType<TransferInDomainDomainsRegistrarResponseResponseBody, z.ZodTypeDef, unknown>;
    /** @deprecated use `TransferInDomainDomainsRegistrarResponseResponseBody$outboundSchema` instead. */
    const outboundSchema: z.ZodType<TransferInDomainDomainsRegistrarResponseResponseBody$Outbound, z.ZodTypeDef, TransferInDomainDomainsRegistrarResponseResponseBody>;
    /** @deprecated use `TransferInDomainDomainsRegistrarResponseResponseBody$Outbound` instead. */
    type Outbound = TransferInDomainDomainsRegistrarResponseResponseBody$Outbound;
}
...
/** @internal */
export type TransferInDomainDomainsRegistrarResponseBody$Outbound = BadRequest$Outbound | ExpectedPriceMismatch$Outbound | DomainNotAvailable$Outbound | TldNotSupported$Outbound | HttpApiDecodeError$Outbound;
/** @internal */
