 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace StaticIpsEnabled$ {
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace Pagination1$ {
    /** @deprecated use `Pagination1$inboundSchema` instead. */
    const inboundSchema: z.ZodType<Pagination1, z.ZodTypeDef, unknown>;
    /** @deprecated use `Pagination1$outboundSchema` instead. */
    const outboundSchema: z.ZodType<Pagination1$Outbound, z.ZodTypeDef, Pagination1>;
    /** @deprecated use `Pagination1$Outbound` instead. */
    type Outbound = Pagination1$Outbound;
}
...
/** @internal */
export declare const GetProjectsPagination$inboundSchema: z.ZodType<GetProjectsPagination, z.ZodTypeDef, unknown>;
/** @internal */
export type GetProjectsPagination$Outbound = Pagination$Outbound | Pagination1$Outbound;
/** @internal */
export declare const GetProjectsPagination$outboundSchema: z.ZodType<GetProjectsPagination$Outbound, z.ZodTypeDef, GetProjectsPagination>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace GetProjectsPagination$ {
    /** @deprecated use `GetProjectsPagination$inboundSchema` instead. */
    const inboundSchema: z.ZodType<GetProjectsPagination, z.ZodTypeDef, unknown>;
    /** @deprecated use `GetProjectsPagination$outboundSchema` instead. */
    const outboundSchema: z.ZodType<GetProjectsPagination$Outbound, z.ZodTypeDef, GetProjectsPagination>;
    /** @deprecated use `GetProjectsPagination$Outbound` instead. */
    type Outbound = GetProjectsPagination$Outbound;
}
export declare function getProjectsPaginationToJSON(getProjectsPagination: GetProjectsPagination): string;
export declare function getProjectsPaginationFromJSON(jsonString: string): SafeParseResult<GetProjectsPagination, SDKValidationError>;
/** @internal */
