 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var UpdateProjectStaticIps$;
(function (UpdateProjectStaticIps$) {
    /** @deprecated use `UpdateProjectStaticIps$inboundSchema` instead. */
    UpdateProjectStaticIps$.inboundSchema = UpdateProjectStaticIps$inboundSchema;
    /** @deprecated use `UpdateProjectStaticIps$outboundSchema` instead. */
    UpdateProjectStaticIps$.outboundSchema = UpdateProjectStaticIps$outboundSchema;
