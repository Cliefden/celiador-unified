...
/** @internal */
export const GetDeploymentHasDeploymentsValue$inboundSchema = z.union([z.string(), z.lazy(() => GetDeploymentValue2$inboundSchema)]);
/** @internal */
export const GetDeploymentHasDeploymentsValue$outboundSchema = z.union([z.string(), z.lazy(() => GetDeploymentValue2$outboundSchema)]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
...
/** @internal */
export const GetDeploymentRoutesKey$inboundSchema = z.union([z.string(), z.lazy(() => GetDeploymentKey2$inboundSchema)]);
/** @internal */
export const GetDeploymentRoutesKey$outboundSchema = z.union([z.string(), z.lazy(() => GetDeploymentKey2$outboundSchema)]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
