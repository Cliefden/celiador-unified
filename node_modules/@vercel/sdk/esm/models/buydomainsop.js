 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var BuyDomainsRequest$;
(function (BuyDomainsRequest$) {
    /** @deprecated use `BuyDomainsRequest$inboundSchema` instead. */
    BuyDomainsRequest$.inboundSchema = BuyDomainsRequest$inboundSchema;
    /** @deprecated use `BuyDomainsRequest$outboundSchema` instead. */
    BuyDomainsRequest$.outboundSchema = BuyDomainsRequest$outboundSchema;
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var BuyDomainsDomainsRegistrarResponseResponseBody$;
(function (BuyDomainsDomainsRegistrarResponseResponseBody$) {
    /** @deprecated use `BuyDomainsDomainsRegistrarResponseResponseBody$inboundSchema` instead. */
    BuyDomainsDomainsRegistrarResponseResponseBody$.inboundSchema = BuyDomainsDomainsRegistrarResponseResponseBody$inboundSchema;
...
})(BuyDomainsDomainsRegistrarResponseResponseBody$ || (BuyDomainsDomainsRegistrarResponseResponseBody$ = {}));
