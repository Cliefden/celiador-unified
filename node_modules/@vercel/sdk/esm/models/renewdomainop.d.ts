 ...
 */
export type RenewDomainDomainsRegistrarResponseBody = BadRequest | DomainNotRegistered | ExpectedPriceMismatch | DomainNotAvailable | TldNotSupported | HttpApiDecodeError;
...
/** @internal */
export declare const RenewDomainDomainsRegistrarResponseResponseBody$outboundSchema: z.ZodType<RenewDomainDomainsRegistrarResponseResponseBody$Outbound, z.ZodTypeDef, RenewDomainDomainsRegistrarResponseResponseBody>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace RenewDomainDomainsRegistrarResponseResponseBody$ {
    /** @deprecated use `RenewDomainDomainsRegistrarResponseResponseBody$inboundSchema` instead. */
    const inboundSchema: z.ZodType<RenewDomainDomainsRegistrarResponseResponseBody, z.ZodTypeDef, unknown>;
    /** @deprecated use `RenewDomainDomainsRegistrarResponseResponseBody$outboundSchema` instead. */
    const outboundSchema: z.ZodType<RenewDomainDomainsRegistrarResponseResponseBody$Outbound, z.ZodTypeDef, RenewDomainDomainsRegistrarResponseResponseBody>;
    /** @deprecated use `RenewDomainDomainsRegistrarResponseResponseBody$Outbound` instead. */
    type Outbound = RenewDomainDomainsRegistrarResponseResponseBody$Outbound;
}
...
/** @internal */
export type RenewDomainDomainsRegistrarResponseBody$Outbound = BadRequest$Outbound | DomainNotRegistered$Outbound | ExpectedPriceMismatch$Outbound | DomainNotAvailable$Outbound | TldNotSupported$Outbound | HttpApiDecodeError$Outbound;
/** @internal */
