...
try {
    if (process.env.SUPABASE_URL && process.env.SUPABASE_SERVICE_ROLE_KEY) {
        ...
        wsService = new WebSocketService(null, // No port - will attach to existing server
        verifyToken, process.env.SUPABASE_URL, process.env.SUPABASE_SERVICE_ROLE_KEY, db // Pass database service for entity operations
        );
...
app.get('/templates', async (req, res) => {
    try {
        ...
        const sortedTemplates = activeTemplates.sort((a, b) => (b.rating || 0) - (a.rating || 0));
