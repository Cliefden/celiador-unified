...
router.get('/api/realtime/connection-info', authenticateUser, (req, res) => {
    try {
...
router.get('/api/realtime/stats', authenticateUser, (req, res) => {
    try {
        const { wsService } = req.app.locals;
        if (!wsService) {
...
router.post('/api/realtime/test-event', authenticateUser, (req, res) => {
    try {
        const { wsService } = req.app.locals;
